...
const FAQ_ITEMS = [
  {
    ...
    a: "כן. ביטול החידוש האוטומטי אפשרי בכל רגע מתוך ההגדרות, בלי התחייבות. הגישה למערכת נשארת פעילה עד תום התקופה ששולמה — האירועים, הגלריות והחוזים שלכם לא נמחקים.",
  },
  {
