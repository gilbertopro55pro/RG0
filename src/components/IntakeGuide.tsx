    ...
    sections: [
      {
        ...
        items: [
          ...
          "תאריך תפוס: העוזר מציע רשימת המתנה. בשישי בערב ובשבת במשך היום (אם סימנת \"לא מצלם בשבת\") הוא מבקש תאריך אחר. מוצאי שבת פתוח.",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "Taken date: the assistant offers the waitlist. On Friday evening and during Saturday (if you ticked \"לא מצלם בשבת\") it asks for another date. Saturday night, after Shabbat ends, is open.",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "Дата занята: ассистент предлагает лист ожидания. В пятницу вечером и в субботу днём (если отмечено \"לא מצלם בשבת\") он просит выбрать другую дату. Вечер субботы, после исхода шаббата, открыт.",
