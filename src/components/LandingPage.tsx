...
const FEATURES = [
  {
    ...
    text: "מעקב אחרי כל שלב באירוע — מסגירה ועד מסירה סופית — כך שכלום לא נופל בין הכיסאות.",
  },
  {
    icon: IconCalendar,
  ...
  {
    icon: IconGallery,
    title: "גלריות מאובטחות ללקוחות",
    text: "קישור אישי לכל אירוע, עם אפשרות בחירת תמונות והורדה — בלי לשלוח קבצים בוואטסאפ.",
  },
  {
    icon: IconContract,
