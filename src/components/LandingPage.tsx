...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ו-5 ערכות עיצוב מלאות (קלאסי, דרמטי, מינימלי, חם, רומנטי) — כל אחת עם פריסת תמונות, צבעים וטיפוגרפיה משלה. מעלים ישירות מהטלפון, גם מאייפון. כלי proofing מובנה לעיצוב אלבום: הלקוח/ה עוברים על עמודי האלבום, כותבים הערות ומאשרים את העיצוב הסופי ישירות מהגלריה — כולל עיצוב חופשי עם כמה תמונות שרוצים בעמוד, ספריית תבניות פריסה לשימוש חוזר, אפקטים (שחור-לבן/סאפיה) ומסגרות לתמונות, שכבות טקסט, נקודות מיקוד לחיתוך, קביעת גודל האלבום בס״מ וייצוא ל-PDF להדפסה, JPG באיכות דפוס או קובץ פוטושופ (PSD) עם שכבות אמיתיות.",
  },
  {
    icon: IconContract,
