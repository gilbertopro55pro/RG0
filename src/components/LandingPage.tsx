...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ו-5 ערכות עיצוב מלאות (קלאסי, דרמטי, מינימלי, חם, רומנטי) — כל אחת עם פריסת תמונות, צבעים וטיפוגרפיה משלה. מעלים ישירות מהטלפון, גם מאייפון. כלי proofing מובנה לעיצוב אלבום: הלקוח/ה עוברים על עמודי האלבום, כותבים הערות ומאשרים את העיצוב הסופי ישירות מהגלריה — כולל עיצוב חופשי של פריסת התמונות, הוספת שכבות טקסט, קביעת נקודות מיקוד לחיתוך התמונות וייצוא ה-PDF הסופי למעבדת הדפוס.",
  },
  {
    icon: IconContract,
