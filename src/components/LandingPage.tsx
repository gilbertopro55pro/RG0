...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ו-5 ערכות עיצוב מלאות (קלאסי, דרמטי, מינימלי, חם, רומנטי) שהופכות את הגלריה שלכם למותג. פריסת פסיפס מרשימה, מעלים ישירות מהטלפון, גם מאייפון.",
  },
  {
    icon: IconContract,
  ...
  },
  {
    ...
    text: "תזכורות תשלום ועדכוני סטטוס נשלחים ללקוחות אוטומטית, בלי שתצטרכו לזכור לעדכן אף אחד.",
  },
  {
    icon: IconLeads,
