...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ובחירת סגנון וצבע לגלריה. מעלים תמונות ישירות מהטלפון — גם מאייפון — בלי בעיות פורמט.",
  },
  {
    icon: IconContract,
