...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ו-5 ערכות עיצוב מלאות (קלאסי, דרמטי, מינימלי, חם, רומנטי) — כל אחת עם פריסת תמונות, צבעים וטיפוגרפיה משלה. מעלים ישירות מהטלפון, גם מאייפון. כלי proofing מובנה לעיצוב אלבום: הלקוח/ה עוברים על עמודי האלבום, כותבים הערות ומאשרים את העיצוב הסופי ישירות מהגלריה — כולל עיצוב חופשי עם כמה תמונות שרוצים בעמוד, ספריית תבניות פריסה (עשרות תבניות מובנות בגדלים שונים, ואפשר לשמור תבניות משלכם) לשימוש חוזר, אפקטים (שחור-לבן/סאפיה), מסגרות עם עובי צבע לבחירה, סיבוב/שקיפות/טשטוש לכל תמונה, תמונת רקע לעמוד, שכבות טקסט עם בחירה מ-20 פונטים (עברית ואנגלית, כולל כתבי יד), נקודות מיקוד לחיתוך, קביעת גודל האלבום בס״מ וייצוא ל-PDF להדפסה, JPG באיכות דפוס או קובץ פוטושופ (PSD) עם שכבות אמיתיות. יצירת האלבום מתחילה בקביעת מידות ההדפסה, ומכאן מוסיפים עמודים אחד-אחד מתבנית שמורה או בעיצוב אישי לפי מספר תמונות עם שיבוץ אוטומטי מהמועדפים (ותמונות ששובצו כבר מסומנות כדי לא לבחור אותן פעמיים) — ולכל תמונה בעיצוב חופשי יש תפריט עגול צף עם אפקט צל בנוסף לכל השאר. עורך העמודים כולל מיקום התמונה בתוך המסגרת בגרירה, זום בגלגלת Ctrl, מסגרת הדפסה ירוקה שמראה את גבולות הבטיחות, קווי יישור חכמים שמסתנכרנים אוטומטית מול אמצע העמוד ותמונות סמוכות, מרכוז תמונה בלחיצת Alt/Cmd, והוספת כמה תמונות בבת אחת עם סידור אוטומטי לפי כיוון (אורך/רוחב) — ובעריכה על מסך גדול העורך נפתח על פני החלון כולו לנוחות העבודה.",
  },
  {
    icon: IconContract,
