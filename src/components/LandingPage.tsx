...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ותמונת שער בעיצוב שלכם — סגנון, צבע וצורה. פריסת פסיפס מרשימה כמו באתרי גלריה מקצועיים. מעלים ישירות מהטלפון, גם מאייפון.",
  },
  {
    icon: IconContract,
