...
const FEATURES = [
  ...
  },
  {
    ...
    text: "קישור אישי לכל אירוע, עם בחירת תמונות והורדה, שיתוף גמיש (וואטסאפ, קוד QR ועוד), ו-5 ערכות עיצוב מלאות (קלאסי, דרמטי, מינימלי, חם, רומנטי) — כל אחת עם פריסת תמונות, צבעים וטיפוגרפיה משלה. מעלים ישירות מהטלפון, גם מאייפון.",
  },
  {
    icon: IconContract,
  ...
  },
  {
    ...
    text: "תזכורות תשלום ועדכוני סטטוס נשלחים ללקוחות אוטומטית, בלי שתצטרכו לזכור לעדכן אף אחד. מחברים חשבון חשבוניות אישי (Finbot) ומפיקים ללקוחות קבלה/חשבונית אמיתית על כל תשלום, ישירות מכרטיס האירוע.",
  },
  {
    icon: IconLeads,
