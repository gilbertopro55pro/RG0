...
module.exports = async ({ page, go, say, point, tap, scroll, sleep, navTap, capTop, on, off, OVERLAY, GID, PORTAL }) => {
  ...
  await scroll(330); await say("הגרף של השנה האחרונה מראה את המגמה, חודש אחרי חודש."); await sleep(4800);
  await scroll(420); await say("כאן רואים אילו חבילות הכי מבוקשות אצלכם."); await sleep(4200);
