...
module.exports = async ({ page, go, say, point, tap, scroll, sleep, navTap, capTop, on, off, OVERLAY, GID, PORTAL }) => {
  ...
  await point(page.locator("button", { hasText: "יצירת הצעת מחיר" })); await say("ישר מתוך הליד בונים ושולחים הצעת מחיר מותאמת, בלי לצאת מהעמוד."); await sleep(4800);
  ...
  await scroll(-400); await tap(page.locator("button", { hasText: "+" })); await say("פנייה חדשה? לוחצים על הפלוס ומוסיפים אותה בכמה שניות."); await sleep(4500);
};
